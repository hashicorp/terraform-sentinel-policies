# [attribute_does_not_have_prefix](../tfstate-functions.sentinel#L685)
...
```
violatingAccessKeys = state.attribute_does_not_have_prefix(allAccessKeys,
                      "pgp_key", "keybase:", true)

violatingEC2Instances = state.attribute_does_not_have_prefix(
