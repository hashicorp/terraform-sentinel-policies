# [resources_by_provider](../tfstate-functions.sentinel#L32)
...
```
currentEC2Resources = state.resources_by_provider("aws")

currentEC2Resources = state.resources_by_provider("registry.terraform.io/hashicorp/aws")

currentAzureResources = state.resources_by_provider("azurerm")

currentGCPResources = state.resources_by_provider("google")

currentVMwareResources = state.resources_by_provider("vsphere")
```
