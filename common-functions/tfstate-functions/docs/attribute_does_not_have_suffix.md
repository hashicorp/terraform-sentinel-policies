# [attribute_does_not_have_suffix](../tfstate-functions.sentinel#L753)
...
```
violatingS3Buckets = state.attribute_does_not_have_suffix(allS3Buckets,
                      "acl", "-full-control", true)

violatingGCESubnets = state.attribute_does_not_have_suffix(
