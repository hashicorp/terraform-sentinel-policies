# [attribute_is_value](../tfstate-functions.sentinel#L533)
...
```
nonPrivateS3Buckets = state.attribute_is_value(allS3Buckets,
                      "acl", "public_read", true)


violatingAzureAppServices = state.attribute_is_value(allAzureAppServices,
