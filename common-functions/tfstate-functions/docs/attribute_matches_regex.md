# [attribute_matches_regex](../tfstate-functions.sentinel#L657)
...
```
violatingACMCerts = state.attribute_matches_regex(allACMCerts,
                    "domain_name", "(.+)\\.hashidemos\\.io$", true)

violatingAccessKeys = state.attribute_matches_regex(allAccessKeys,
