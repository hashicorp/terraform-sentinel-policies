# [attribute_in_list](../tfstate-functions.sentinel#L301)
...
```
violatingEC2Instances = state.attribute_in_list(allEC2Instances,
                        "instance_type", forbidden_types, true)

violatingAzureVMs = state.attribute_in_list(allAzureVMs,
                    "vm_size", forbidden_sizes, true)

violatingGCEInstances = state.attribute_in_list(allGCEInstances,
