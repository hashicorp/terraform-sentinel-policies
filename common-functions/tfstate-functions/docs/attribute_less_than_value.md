# [attribute_less_than_value](../tfstate-functions.sentinel#L595)
...
```
lowCPUVMs = state.attribute_less_than_value(allVMs,
             "num_cpus", minCPUs, true)


lowMemoryVMs = state.attribute_less_than_value(allVMs,
