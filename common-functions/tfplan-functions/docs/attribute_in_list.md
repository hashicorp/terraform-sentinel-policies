# [attribute_in_list](../tfplan-functions.sentinel#L352)
...
```
violatingEC2Instances = plan.attribute_in_list(allEC2Instances,
                        "instance_type", forbidden_types, true)

violatingAzureVMs = plan.attribute_in_list(allAzureVMs,
                    "vm_size", forbidden_sizes, true)

violatingGCEInstances = plan.attribute_in_list(allGCEInstances,
