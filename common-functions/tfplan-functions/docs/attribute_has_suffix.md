# [attribute_has_suffix](../tfplan-functions.sentinel#L974)
...
```
violatingS3Buckets = plan.attribute_has_suffix(allS3Buckets,
                      "acl", "-full-control", true)

violatingGCESubnets = plan.attribute_has_suffix(
