# [attribute_matches_regex](../tfplan-functions.sentinel#L844)
...
```
violatingACMCerts = plan.attribute_matches_regex(allACMCerts,
                    "domain_name", "(.+)\\.hashidemos\\.io$", true)

violatingAccessKeys = plan.attribute_matches_regex(allAccessKeys,
