# [attribute_is_value](../tfplan-functions.sentinel#L622)
...
```
nonPrivateS3Buckets = plan.attribute_is_value(allS3Buckets,
                      "acl", "public_read", true)


violatingAzureAppServices = plan.attribute_is_value(allAzureAppServices,
