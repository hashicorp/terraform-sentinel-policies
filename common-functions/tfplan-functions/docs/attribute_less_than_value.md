# [attribute_less_than_value](../tfplan-functions.sentinel#L748)
...
```
lowCPUVMs = plan.attribute_less_than_value(allVMs,
             "num_cpus", minCPUs, true)


lowMemoryVMs = plan.attribute_less_than_value(allVMs,
